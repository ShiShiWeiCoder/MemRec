...
data_dir = os.path.join(base_dir, 'data', dataset_name, 'proc_data')
...
model_list = ['DeepFM', 'DCN', 'FiBiNet', 'FiGNN', 'AutoInt', 'DIN', 'DIEN']
...
# nohup python training/rank_run.py --dataset mooc > logs/rank_multilevel_memory.log 2>&1 &
